...
A Google Drive link to your PDF
...
Asks you for a Google Drive link to your PDF
Extracts the file ID from the link
Downloads the PDF into a local data/ folder
Saves it as data/source.pdf
